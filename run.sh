...
echo "    Usuarios : http://localhost:3000/api/users"
...
echo ""
echo -e "${GREEN}  Users Service (directo):${NC}"
echo "    Health   : http://localhost:3002/health"
echo "    Swagger  : http://localhost:3002/docs"
echo ""
...
echo "    Logs de users        : docker compose logs -f users-service"
